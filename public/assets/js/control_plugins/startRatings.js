...
window.fbControls.push(function (controlClass) {
  ...
  class controlStarRating extends controlClass {
     ...
     */
    build() {
      // Use a dynamic label if provided in the config, otherwise default to "haleluya"
      let labelText = this.config.label || "haleluya";
      console.log(this.markup('span', labelText, {id: this.config.name}))
      return this.markup('span', labelText, {id: this.config.name});
    }
